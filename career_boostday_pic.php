...
// Permission gate
if (!(current_user_can('career_boost_day_pic_manage') || current_user_can('manage_settings'))) {
...
<head>
    ...
    <title>Career Boost Day PIC | Admin</title>
...
<div class="container py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3">
        <div>
            <h1 class="h4 mb-1">PIC - Career Boost Day</h1>
