...
<?php kh_proto_render_hero('Pasker Connect', 'Dokumentasi API eksternal WLLP untuk integrasi stakeholder portal kerja.', 'Lowongan Kerja', 'karirhub_employer_prototype_pelaporan_lowongan', 'Proyek', 'karirhub_employer_prototype_dashboard_wllp', false); ?>
    ...
    "has_more": false
                    ...
                    <div class="pc-endpoint-card mb-3">
                        ...
                        <div class="pc-kv mb-2">
                            ...
                            <div class="k">Narrative reference</div><div class="v">Ini endpoint tulis paling penting pada alur WLLP. Jika request valid, sistem akan membuat nomor bukti dan id lowongan secara otomatis.</div>
                        </div>
