            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="karirhubEmployerPrototypeDropdown">
                        ...
                        <?php if (($canKhProtoPelaporan || $canKhProtoStatusKeterisian || $canAdminReviewLaporanPrototype) && ($canKhProtoDashboardWllp || $canKhProtoDashboardWllpAdmin || $canKhProtoJobPosted || $canKhProtoBuktiLapor)): ?><li><hr class="dropdown-divider"></li><?php endif; ?>
