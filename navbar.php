...
<?php
    ...
    $hasSettings = $hasSettings || $canKhProtoEws;
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
                        ...
                        <?php if ($canKhProtoEws): ?><li><a class="dropdown-item" href="<?php echo $rootUrl; ?>karirhub_employer_prototype_dashboard_ews"><i class="bi bi-shield-exclamation me-1"></i>EWS</a></li><?php endif; ?>
                        <li><hr class="dropdown-divider"></li>
                        ...
                        <?php if ($canManageSettings || $canIframe): ?><li><a class="dropdown-item" href="<?php echo $rootUrl; ?>iframe/karirhub_iframe1">Karirhub iFrame 1</a></li><?php endif; ?>
                        <?php if ($canManageSettings || $canIframe): ?><li><a class="dropdown-item" href="<?php echo $rootUrl; ?>iframe/karirhub_iframe2">Karirhub iFrame 2</a></li><?php endif; ?>
                        <?php if ($canManageSettings || $canIframe): ?><li><a class="dropdown-item" href="<?php echo $rootUrl; ?>iframe/karirhub_iframe3">Karirhub iFrame 3</a></li><?php endif; ?>
