...
if (!(current_user_can('view_dashboard_persediaan_tk') || current_user_can('manage_settings'))) { http_response_code(403); echo 'Forbidden'; exit; }
...
$iframe = fetchIframe($conn, 'Dashboard Persediaan Tenaga Kerja');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Dashboard Persediaan Tenaga Kerja</title>
...
<div class="container py-4">
    <h2 class="mb-3">Dashboard Persediaan Tenaga Kerja</h2>
