...
function ac_seed_permissions(mysqli $conn): void {
	$perms = [
		...
		['view_dashboard_integrasi_karirhub_mitra','View Dashboard Monitoring Integrasi Karirhub x Mitra','Dashboard'],
		['view_dashboard_integrasi_karirhub_pemda','View Dashboard Monitoring Integrasi Karirhub x Pemda','Dashboard'],
		...
		['settings_integrasi_karirhub_mitra_manage','Manage Dashboard Monitoring Integrasi Karirhub x Mitra','Settings'],
		...
		['company_evaluation_survey_manage','Manage Company Evaluation Survey','Layanan'],
		...
		['karirhub_employer_prototype_pelaporan_lowongan_view','Karirhub Employer Prototype: View Pelaporan Lowongan','Karirhub Employer Prototype'],
		['karirhub_employer_prototype_status_keterisian_view','Karirhub Employer Prototype: View Status Keterisian','Karirhub Employer Prototype'],
		['karirhub_employer_prototype_monitoring_kepatuhan_view','Karirhub Employer Prototype: View Monitoring Kepatuhan','Karirhub Employer Prototype'],
		['karirhub_employer_prototype_no_reg_bukti_view','Karirhub Employer Prototype: View No. Reg Bukti','Karirhub Employer Prototype'],
		...
		['karirhub_employer_prototype_monitoring_laporan_view','Karirhub Employer Prototype: View Dashboard Monitoring Laporan Lowongan & Perusahaan','Karirhub Employer Prototype'],
		['karirhub_employer_prototype_ews_view','Karirhub Employer Prototype: View Early Warning System','Karirhub Employer Prototype'],
		['karirhub_employer_prototype_employer_individu_view','Karirhub Employer Prototype: View Employer Individu','Karirhub Employer Prototype'],
